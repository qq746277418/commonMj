...
cc.game.onStart = function(){
    ...
    var visibleSizeWidth = 1280;
    var visibleSizeHeight = 720;
    ...
    if (cc.sys.os === cc.sys.OS_IOS)
    {
        ...
        cc.view.setDesignResolutionSize(visibleSizeWidth, visibleSizeHeight, cc.ResolutionPolicy.NO_BORDER);
    }
    else
    {
        cc.view.setDesignResolutionSize(visibleSizeWidth, visibleSizeHeight, cc.ResolutionPolicy.EXACT_FIT);
    }
